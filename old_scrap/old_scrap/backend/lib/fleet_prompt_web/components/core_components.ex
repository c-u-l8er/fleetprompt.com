defmodule FleetPromptWeb.CoreComponents do
  ...
  def flash(assigns) do
    ...
    >
      <div class={[
        ...
        @kind == :info && "border-primary/30 bg-primary/10",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FleetPromptWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FleetPromptWeb.Gettext, "errors", msg, opts)
    end
  end
